...
<table width="100%" border="1">
    ...
    <s:iterator value="allCrmDepartment" status="department">
        <tr class="<s:property value="#department.even?'tabtd2':'tabtd1'"/>">
            <td align="center"><s:property value="depName"/></td>
            <td width="7%" align="center">
                <s:a action="departmentAction_editDepartment" namespace="/">
                    <s:param name="depId" value="depId"></s:param>
                    <s:param name="depName" value="depName"></s:param>
