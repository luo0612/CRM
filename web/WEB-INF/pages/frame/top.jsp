    ...
    <tr>
        <td>
            <table border="0" width="100%" cellspacing="0" cellpadding="0" id="table2">
                <tr>
                    <td width="420">
                        <img border="0" src="${pageContext.request.contextPath}/images/topbg.jpg" width="436"
                             height="80"></td>
                                ...
                                <tr>
                                    <td width="150" height="35"><p align="right">
                                        <font color="#FFFFFF">欢迎您：
                                            ${sessionScope.staff.loginName} <b></b>
                                        </font>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <td>
                                    <div align="right">
                                        <table border="0" width="215" cellspacing="0" cellpadding="0" id="table6"
                                               height="23">
                                            <tr>
                                                <td width="26"><img border="0"
                                                                    src="${pageContext.request.contextPath}/images/pwd.gif">
                                                </td>
                                                ...
                                                <td width="55" valign="middle"><a
                                                        href="${pageContext.request.contextPath}/staff/staffAction_logout"
